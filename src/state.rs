...
mod tests {
    use super::{
        branch_and_slug, issue_fingerprint, parse_directive, parse_prompted_directive, pr_outcome,
        Directive, IssueState, Phase, PostedRef, PrOutcome, ReactionWatch, WaitState,
    };
